function SaveM = simu_sudden_decrease_PI(CI, PI)
% PI should initially at least more than 0.3
...
for t=1:intervall
    ...
    % PI is getting reduced suddenly at half Simulation Duration
    if t==0.5*intervall
        PI = 0.5*PI;
    end
...
% Plot the data
create_plot_population(SaveNum, CI, 2*PI);
